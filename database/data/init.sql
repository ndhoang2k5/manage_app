...
-- 19.1. Lịch sử biến động tồn kho (phục vụ kiểm tồn kế toán vs Salework)
-- Lưu dữ liệu import từ Excel báo cáo kiểm kê kho (bao_cao_ton_kho.xlsx) để hiển thị Tăng/Giảm + xem chi tiết.
